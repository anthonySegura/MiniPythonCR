...
public class Preferencias {
	...
	public Preferencias(MPGrammarLexer scanner, MPGrammarParser parser){
		...
		try {
			...
			while ((linha = leitor.readLine()) != null) {
				...
				if (sub.equals("1")) {
					...
					editor = new JCEditor(scanner, parser);
	...
	private void lafJCE() {
		try {
			...
			UIManager.getLookAndFeelDefaults().put(
				...
				new com.textEditor.PainterScrollBar(new Color(69, 69, 69)));
			UIManager.getLookAndFeelDefaults().put(
				"ScrollBar:ScrollBarThumb[MouseOver].backgroundPainter",
				new com.textEditor.PainterScrollBar(new Color(69, 69, 69)));
			UIManager.getLookAndFeelDefaults().put(
				"ScrollBar:ScrollBarTrack[Enabled].backgroundPainter",
				new com.textEditor.PainterScrollBar(new Color(39, 39, 39)));
