...
public class JCEditor extends JFrame {
    ...
    //Parser y Scanner de MiniPython
    MPGrammarLexer scanner;
    MPGrammarParser parser;
	...
	private JButton bNovo, bAbrir, bSalvar, bSalvarComo, bCopiar, bColar, bRecortar, bPesquisar, BtnCompilar, BtnAST ,bImprimir, bDesfazer, bRefazer;
	private Image icone;
	...
	*/
	public JCEditor(MPGrammarLexer scanner, MPGrammarParser parser) {
		...
		//Sintaxis de Python por defecto
        LinguagemListener pythonListener = new LinguagemListener("Python", SyntaxConstants.SYNTAX_STYLE_PYTHON);
        pythonListener.setPython();
	...
	*/
	public void construirGUI() {
		...
		panel.setBackground(new Color(193, 26, 39));
        ...
        panelPrincipal.getRightComponent().setVisible(false);
        ...
        consoleTextArea.setBackground(new Color(39, 40, 34));
		...
		getContentPane().add(BorderLayout.SOUTH, consolePanel);	// apenas define o layout dos componentes
	...
	*/
	private void salvarAoSair() {
		...
		new Preferencias(scanner, parser).salvarPreferencias(sLAF, sTema, fonteEscolhida, tamanhoFonte, dobCodigo, quebLinha);
		new Preferencias(scanner, parser).salvarArquivosAbertos(arquivosAbertos);
		adp.salvarProjetos();
		System.exit(0);
	}
	...
	*/
    ...
    /**
     * Metodo para mostrar mensajes desde el panel de errores
     */
	...
	* a String "sLAF" é utilizada pela classe JCEditorMain para carregar o LAF toda
	...
	*/
	class PortugolListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			...
			atmf.putMapping("text/portugol", "PortugolTokenMaker");
	...
	*/
	class PotigolListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			AbstractTokenMakerFactory atmf = (AbstractTokenMakerFactory) TokenMakerFactory.getDefaultInstance();
			atmf.putMapping("text/potigol", "PotigolTokenMaker");
    ...
    /**
     * Evento para el boton de compilar
     * Llama al método del parser
     */
